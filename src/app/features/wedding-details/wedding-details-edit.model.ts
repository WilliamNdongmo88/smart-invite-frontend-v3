...
export const WEDDING_THEME_PRESETS: WeddingThemePreset[] = [
  ...
  // ── Nouveaux presets ──────────────────────────────────────────
  {
    id: 'forest-green',
    name: 'Forêt & Mousse',
    description: 'Verdure dense et tons naturels — mariage champêtre et organique',
    badge: '🌲',
    primaryColor:    '#a3c585',
    secondaryColor:  '#6d9e50',
    secondaryDeep:   '#3d6b30',
    backgroundColor: '#0e1a0f',
    cardBackground:  '#162218',
    sectionBg:       '#111d13',
    surfaceBg:       '#162218',
    textColor:       '#edf5ea',
    textSecondary:   '#a3b89e',
    swatches: [
      { color: '#6d9e50', label: 'Vert Mousse' },
      { color: '#a3c585', label: 'Sauge Claire' },
      { color: '#3d6b30', label: 'Forêt' },
      { color: '#d4b896', label: 'Lin Naturel' },
    ],
  },
  {
    id: 'midnight-silver',
    name: 'Minuit & Argent',
    description: 'Noir profond et reflets argentés — élégance feutrée et moderne',
    badge: '🌙',
    primaryColor:    '#c0c8d4',
    secondaryColor:  '#e8edf2',
    secondaryDeep:   '#8898a8',
    backgroundColor: '#080c10',
    cardBackground:  '#10161e',
    sectionBg:       '#0c1218',
    surfaceBg:       '#10161e',
    textColor:       '#f0f4f8',
    textSecondary:   '#a0aab4',
    swatches: [
      { color: '#c0c8d4', label: 'Argent Pâle' },
      { color: '#e8edf2', label: 'Blanc Acier' },
      { color: '#8898a8', label: 'Acier' },
      { color: '#080c10', label: 'Minuit Absolu' },
    ],
  },
  {
    id: 'dusty-rose',
    name: 'Rose Poudrée & Crème',
    description: 'Douceur romantique et tons pastel — féminin et intemporel',
    badge: '🌷',
    primaryColor:    '#c4848e',
    secondaryColor:  '#daa8b0',
    secondaryDeep:   '#9a5a64',
    ...
    swatches: [
      { color: '#c4848e', label: 'Rose Poudré' },
      { color: '#daa8b0', label: 'Pétale' },
      { color: '#f0d8dc', label: 'Crème Rose' },
      { color: '#9a5a64', label: 'Vieux Rose' },
    ],
  },
  {
    id: 'sunset-coral',
    name: 'Coucher de Soleil',
    description: 'Corail vibrant et or chaud — énergie tropicale et joyeuse',
    badge: '🌅',
    primaryColor:    '#e8825a',
    secondaryColor:  '#f4b060',
    secondaryDeep:   '#b85030',
    backgroundColor: '#1a0e08',
    cardBackground:  '#261510',
    sectionBg:       '#1e1008',
    surfaceBg:       '#261510',
    textColor:       '#fff5f0',
    textSecondary:   '#d4a898',
    swatches: [
      { color: '#e8825a', label: 'Corail' },
      { color: '#f4b060', label: 'Ambre' },
      { color: '#b85030', label: 'Brique' },
      { color: '#ffd4b0', label: 'Saumon Clair' },
    ],
  },
  {
    id: 'pearl-white',
    name: 'Blanc Pur & Perle',
    description: 'Minimalisme immaculé — mariage épuré, moderne et intemporel',
    badge: '🤍',
    primaryColor:    '#c8b8a0',
    secondaryColor:  '#b0a090',
    secondaryDeep:   '#806858',
    backgroundColor: '#ffffff',
    cardBackground:  '#f8f6f4',
    sectionBg:       '#f2f0ee',
    surfaceBg:       '#f8f6f4',
    textColor:       '#1a1410',
    ...
    swatches: [
      ...
      { color: '#c8b8a0', label: 'Perle' },
      { color: '#f8f6f4', label: 'Crème Nacre' },
      { color: '#b0a090', label: 'Taupe Doux' },
    ],
  },
  {
    id: 'ocean-blue',
    name: 'Océan & Turquoise',
    description: 'Profondeur marine et reflets aquatiques — mariage en bord de mer',
    badge: '🌊',
    primaryColor:    '#2ab5c8',
    secondaryColor:  '#5dd8e8',
    secondaryDeep:   '#1888a0',
    backgroundColor: '#04131a',
    cardBackground:  '#071e2a',
    sectionBg:       '#051820',
    surfaceBg:       '#071e2a',
    textColor:       '#e8f8fc',
    textSecondary:   '#88c8d8',
    swatches: [
      { color: '#2ab5c8', label: 'Turquoise' },
      { color: '#5dd8e8', label: 'Aqua' },
      { color: '#1888a0', label: 'Bleu Profond' },
      { color: '#a8e8f0', label: 'Ciel Marin' },
    ],
  },
  {
    id: 'copper-bronze',
    name: 'Cuivre & Bronze',
    description: 'Chaleur métallique et profondeur brune — luxe industriel chic',
    badge: '🏆',
    primaryColor:    '#c8724a',
    secondaryColor:  '#e09060',
    secondaryDeep:   '#904020',
    backgroundColor: '#120a06',
    cardBackground:  '#1e1008',
    sectionBg:       '#180c06',
    surfaceBg:       '#1e1008',
    textColor:       '#fff0e8',
    textSecondary:   '#c8a890',
    swatches: [
      { color: '#c8724a', label: 'Cuivre' },
      { color: '#e09060', label: 'Bronze Poli' },
      { color: '#904020', label: 'Rouille' },
      { color: '#f0c8a0', label: 'Sable Chaud' },
    ],
  },
  {
    id: 'midnight-floral',
    name: 'Nuit Fleurie',
    description: 'Fond nuit profond et floraux colorés — romantisme bohème et mystérieux',
    badge: '🌸',
    primaryColor:    '#e8a0c0',
    secondaryColor:  '#f0c8a0',
    secondaryDeep:   '#b86080',
    backgroundColor: '#100818',
    cardBackground:  '#1a1028',
    sectionBg:       '#140c20',
    surfaceBg:       '#1a1028',
    textColor:       '#fff0f8',
    textSecondary:   '#d0a8c0',
    swatches: [
      { color: '#e8a0c0', label: 'Rose Nuit' },
      { color: '#f0c8a0', label: 'Pêche Dorée' },
      { color: '#b86080', label: 'Pivoine' },
      { color: '#c8a0e0', label: 'Lilas Nuit' },
    ],
  },
];
